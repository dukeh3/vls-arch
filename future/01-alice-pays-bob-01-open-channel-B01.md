...
Part of [Scenario 01 — Alice Pays Bob](01-alice-pays-bob.md). Follows [A01](01-alice-pays-bob-01-open-channel-A01.md).
...
This is structurally identical to [A01](01-alice-pays-bob-01-open-channel-A01.md) — same three VLS calls, same proxy optimization.
...
Same mechanism as [A01](01-alice-pays-bob-01-open-channel-A01.md): node-proxy sees `NewChannel`, sends `vls_accept_channel` speculatively, caches the reply.
...
After `accept_channel` is sent, Alice processes it and prepares the funding transaction → [A02](01-alice-pays-bob-01-open-channel-A02.md).
