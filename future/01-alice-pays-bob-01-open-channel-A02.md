...
Part of [Scenario 01 — Alice Pays Bob](01-alice-pays-bob.md). Follows [B01](01-alice-pays-bob-01-open-channel-B01.md).
...
After `funding_created` is sent, Bob processes it → [B02](01-alice-pays-bob-01-open-channel-B02.md).
